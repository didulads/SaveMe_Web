                ...
                <div class="x_panel">
                  <div>
					...
					<br></br>
                      ...
                      <tbody>
                        <?php
							$logpurch = "SELECT * FROM packagepurchases AS pp LEFT JOIN package AS p ON pp.packageid = p.Package_id WHERE pp.organizationId = '$orgID';";
							...
							while($row = mysqli_fetch_assoc($logres)){
								...
								if($row['offeradvert']==1){
									echo '<td>With Advertising</td>';
								}
								else{
									echo '<td>Without Advertising</td>';
								}
