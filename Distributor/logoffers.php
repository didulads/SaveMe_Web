                ...
                <div class="x_panel">
				  ...
				  <br></br>
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php
							$logpurch = "SELECT * FROM offerings WHERE organizationId = '$orgID';";
							$logres = mysqli_query($conn,$logpurch);
							while($row = mysqli_fetch_assoc($logres)){
								echo '<tr>';
								echo '<td>'.$row['offeringId'].'</td>';
								echo '<td>'.$row['itemName'].'</td>';
								echo '<td>'.$row['itemBarcode'].'</td>';
								echo '<td>'.$row['itemDescription'].'</td>';
								echo '<td>'.$row['offeredCoinAmount'].'</td>';
								...
								echo '<td>'.$row['offerUpdated'].'</td>';
								echo '<td>'.$row['offerEndDate'].'</td>';
								echo '</tr>';
							}
						?>
                      </tbody>
